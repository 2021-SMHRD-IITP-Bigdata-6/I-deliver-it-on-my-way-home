		...
		<script type="text/javascript">
			...
			var marker1 = new Tmapv2.Marker({
				...
				$.ajax({
							...
							success : function(response) {
								...
								//결과 출력
								tDistance = "배달자1의 거리 : "+ ((resultData[0].properties.totalDistance) / 1000).toFixed(1) + "km ";
							   tTime = " 시간 : "+ ((resultData[0].properties.totalTime) / 60).toFixed(0) + "분";
								document.getElementById("man1").innerHTML="<strong>"+tDistance + tTime+"</strong>";
			...
			var marker1 = new Tmapv2.Marker({
				...
				$.ajax({
							...
							success : function(response) {
								var resultData2 = response.features;
								//결과 출력
								var tDistance2 = "배달자1의 거리 : "+ ((resultData2[0].properties.totalDistance) / 1000).toFixed(1) + "km ";
								var tTime2 = " 시간 : "+ ((resultData2[0].properties.totalTime) / 60).toFixed(0) + "분";
								document.getElementById("man1").innerHTML=tDistance2 + tTime2;
								...
								drawInfoArr = [];
								for ( var i in resultData2) { //for문 [S]
									var geometry = resultData2[i].geometry;
									var properties = resultData2[i].properties;
									var polyline_;
									if (geometry.type == "LineString") {
										for ( var j in geometry.coordinates) {
											// 경로들의 결과값(구간)들을 포인트 객체로 변환 
			...
			function man2() {
				...
				marker_s = new Tmapv2.Marker(
						{ 
							...
							position : new Tmapv2.LatLng(delivery2y, delivery2x),
							icon : "http://tmapapi.sktelecom.com/upload/tmap/marker/pin_r_m_s.png",
							iconSize : new Tmapv2.Size(36, 48),
							map : map,
							title : "배달자"
			...
			var marker1 = new Tmapv2.Marker({
				...
				$.ajax({
							...
							success : function(response) {
								var resultData2 = response.features;
								//결과 출력
								var tDistance2 = "배달자2의 거리 : "+ ((resultData2[0].properties.totalDistance) / 1000).toFixed(1) + "km ";
								var tTime2 = " 시간 : "+ ((resultData2[0].properties.totalTime) / 60).toFixed(0) + "분";
								document.getElementById("man2").innerHTML="<strong>"+tDistance2 + tTime2+"</strong>";
			...
			function man3() {
				...
				marker_s = new Tmapv2.Marker(
						{ 
							...
							position : new Tmapv2.LatLng(delivery3y, delivery3x),
							icon : "http://tmapapi.sktelecom.com/upload/tmap/marker/pin_r_m_s.png",
							iconSize : new Tmapv2.Size(36, 48),
							map : map,
							title : "배달자"
			...
			var marker1 = new Tmapv2.Marker({
				...
				$.ajax({
							...
							success : function(response) {
								...
								var tDistance2 = "배달자2의 거리 : "+ ((resultData2[0].properties.totalDistance) / 1000).toFixed(1) + "km ";
								var tTime2 = " 시간 : "+ ((resultData2[0].properties.totalTime) / 60).toFixed(0) + "분";
								document.getElementById("man3").innerHTML="<strong>"+tDistance2 + tTime2+"</strong>";
