...
<body>
        ...
        <div class="login_box" style="background-color: #ead7c6;">
         <a href="/"><img src="/img/로긴페이지1-001.png" style="width:250px;height:200px;" alt="이미지" class="bm_img"></a>    
            ...
            <form action="/login_check" method="post">
               ...
               <button type="submit" id="btnLogin" style="width: 300px; border-radius:10px">로그인 </button>
               ...
               <div style="color:red;"> 로그아웃되었습니다.
                  ...
                  <div>
                     ...
                     <br>
                     <div style="color: black;"><a href="/join2" >회원 가입하러 가기</a></div>
                     <br>
                  </div>
               </div>
            </div>
             <img src="/img/sakura123.png" style="width:100px;height:100px; position: relative; left:255px; top:97px;">
            </form>
